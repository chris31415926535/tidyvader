dict_sent_sorted <- dplyr::tribble(
~word, ~sentiment,
"$:", -1.5,
"%)", -0.4,
"%-)", -1.5,
...
dict_sent_word <- dict_sent_sorted$word
dict_sent_value <- dict_sent_sorted$sentiment

dict_punct_sorted <- dict_sent_sorted %>% dplyr::filter(stringr::str_detect(word, "[[:punct:]]"))

dict_punct_word <- dict_punct_sorted$word
dict_punct_value <- dict_punct_sorted$sentiment

# usethis::use_data(dict_sent_sorted, internal=TRUE, overwrite= TRUE)
# usethis::use_data(dict_sent_word, internal=TRUE, overwrite = TRUE)
# usethis::use_data(dict_sent_value, internal=TRUE, overwrite = TRUE)
#
# usethis::use_data(dict_punct_sorted, internal=TRUE, overwrite = TRUE)
# usethis::use_data(dict_punct_word, internal=TRUE, overwrite = TRUE)
# usethis::use_data(dict_punct_value, internal=TRUE, overwrite = TRUE)
